import { Golongan, Jabatan, Pangkat, Pegawai } from "@/libs/db/types";
import {
  Button,
  ComboboxItem,
  Group,
...
function ModalUpdatePegawai({ opened, close }: Props) {
  const pegawai = useAppSelector<Pegawai | null>(
    (x) => x.masterData.pegawai.item,
  );
...
export default ModalUpdatePegawai;
